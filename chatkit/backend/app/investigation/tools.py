"""Function tools for the shell-first next-generation investigation agent."""
...
def investigation_instructions() -> str:
    ...
    return (
        ...
        "Every conclusion should reference run_id and relevant dataset ids.\n"
...
async def investigate_issue(
    ...
    await _stream_progress(ctx, "search", "Starting next-gen investigation pipeline.")
